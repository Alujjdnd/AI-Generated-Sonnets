...
#Enabled to avoid runtime errors
...
path_to_file = tf.keras.utils.get_file('geosample.txt', 'https://raw.githubusercontent.com/Alujjdnd/tensorFlowTextGen/master/assets/geosample.txt')
...
history = model.fit(dataset, epochs=EPOCHS, callbacks=[checkpoint_callback], steps_per_epoch=SPE)
...
print(generate_text(model, start_string=u"STARTS HERE: "))
